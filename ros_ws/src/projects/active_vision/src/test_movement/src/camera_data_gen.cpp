...
void automated_training_procedure(std::string object_xml_parsed)
{
	...
	//save file location
	move_camera camera;
	//Un comment the line below to record the results
	//std::ofstream d_file;
...
ifstream file("/home/cmb/singularity/active_vision/mer_lab/ros_ws/src/projects/active_vision/src/object_models/models/urdf/sugar_box.urdf");
file>>noskipws;
