...
class Insert(SingleArmEnv):
    ...
    def reward(self, action=None):
        ...
        Sparse un-normalized reward:
            ...
            - a discrete reward of 2.25 is provided if the hole is lifted

        Un-normalized summed components if using reward shaping:

            - Reaching: in [0, 1], to encourage the arm to reach the hole
            - Grasping: in {0, 0.25}, non-zero if arm is grasping the hole
            - Lifting: in {0, 1}, non-zero if arm has lifted the hole
    ...
    def _load_model(self):
        ...
        if self.placement_initializer is not None:
            ...
            self.placement_initializer = UniformRandomSampler(
                ...
                x_range=[-0.15/2.0, -0.15/2.0],
                y_range=[-0.15/2.0, -0.15/2.0], 
                rotation=0.0, #None,
                rotation_axis='z',
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [hole_pos, hole_quat, gripper_to_hole_pos]
    ...
    def _check_success(self):
        ...
        # hole is higher than the table top above a margin
        return hole_height > table_height + 0.04
